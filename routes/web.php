...
Route::group(['middleware' => ['AuthCheck']], function()
{
    ...
    Route::get('/device/update/device/db/{id}', [Hostes::class,'updateDevDb'])->name('hostes.device.update')->middleware('Admin');
    ...
    Route::get('/user/profile',[Users::class,'show'])->name('users.show');
